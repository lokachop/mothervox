...
local function decodeChunk(idx, fBuff, univObj, convLUT)
	...
	local voxelData = ZVox.DeSerializeChunkVoxelData(voxelDataSerial)
	...
	local voxelState = ZVox.DeSerializeChunkVoxelData(voxelStateSerial)
...
local function decodeV3(fPtr, univTargetName)
...
DECODER["decodeFunc"] = decodeV3
ZVOX_DECODER_LIST[3] = DECODER